...
# Form implementation generated from reading ui file '/__w/probe_basic/probe_basic/source/debian/python3-probe-basic/usr/share/configs/atc_sim/user_atc_buttons/template_user_atc_buttons/template_user_atc_buttons.ui'
#
...
class Ui_USER_ATC_BUTTONS(object):
    def setupUi(self, USER_ATC_BUTTONS):
        ...
        USER_ATC_BUTTONS.resize(300, 472)
...
"}")
        ...
        self.verticalLayout_66.setContentsMargins(20, 18, 20, 15)
